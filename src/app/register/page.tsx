    ...
    return (
        <div className="auth-wrapper animate-fade-in">
            <div className="glass-panel auth-container">
                <h1 className="page-title" style={{ fontSize: '36px', textAlign: 'center', marginBottom: '8px' }}>Pintu Kehormatan.</h1>
                ...
                <form style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
                    <div>
                        ...
                        <input type="text" placeholder="Cth: John Doe" className="styled-input" required />
                    </div>
                    ...
                    <Link href="/dashboard" className="styled-button" style={{ marginTop: '20px' }}>
                        Inisialisasi Akun <ArrowRight size={20} />
                    </Link>
                </form>
